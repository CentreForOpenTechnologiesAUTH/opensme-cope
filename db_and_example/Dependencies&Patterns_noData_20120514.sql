CREATE DATABASE  IF NOT EXISTS `dependencies` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `dependencies`;
...
--
-- Table structure for table `dependenciesType`
--

DROP TABLE IF EXISTS `dependenciesType`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dependenciesType` (
  `dependee` bigint(20) NOT NULL,
  `dependency` bigint(20) NOT NULL,
  `depencencyType` varchar(45) NOT NULL,
  `depencencySubType` varchar(45) NOT NULL,
  `times` int(11) DEFAULT NULL,
  PRIMARY KEY (`dependee`,`dependency`,`depencencyType`,`depencencySubType`),
  KEY `fk_dependenciesType_1` (`dependee`),
  KEY `fk_dependenciesType_2` (`dependency`),
  CONSTRAINT `fk_dependenciesType_1` FOREIGN KEY (`dependee`) REFERENCES `classes` (`classid`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_dependenciesType_2` FOREIGN KEY (`dependency`) REFERENCES `classes` (`classid`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-05-31 14:30:08
