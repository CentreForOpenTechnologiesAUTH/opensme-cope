...
public class GeneratePatternProgressPanel extends JPanel implements ActionListener, PropertyChangeListener {
    ...
    public GeneratePatternProgressPanel(ReuseProject reuseProject, ComponentAdaptationEnvironmentMain c) {
        super(new BorderLayout());
        patternAnalyzer = new PatternAnalyzer(reuseProject);
        //Create the UI.
