...
public class ClassMetrics {
    ...
    /** Vector with names of dependencies not found*/
    private Vector<String> depNotFound;
    
    public HashMap<String,String> ditHierarchy;
	...
	depNotFound = new Vector<String>(0);
        ditHierarchy = new HashMap<String,String>();
    }
    ...
    public void addDependencyNotFound(String name){
    	this.depNotFound.addElement(name);
    }
    
    public Vector<String> getDependenciesNotFound(){
    	return this.depNotFound;
    }
    
    public void addDITHierarchyDependency(String superclass, String subclass){
        ditHierarchy.put(superclass, subclass);
    }
    
    public HashMap<String,String> getDITHierarchyDependencies(){
        return ditHierarchy;
    }
