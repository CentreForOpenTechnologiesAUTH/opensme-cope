...
public class ClusterResult {
    ...
    public List<TsantalisPatternInstance> getPatternInstanceList() {
        ...
        List<TsantalisPatternInstance> patternInstanceList = new ArrayList<TsantalisPatternInstance>();
        ...
        if(!entryTupleSet.isEmpty()) {
	        ...
	        for(ClusterResult.EntryTuple tuple : entryTupleSet) {
	        	if(tuple.getRelationshipScore() == maxRelationshipScore) {
	        		...
	        		TsantalisPatternInstance instance = new TsantalisPatternInstance();
