...
//      System.out.println("ca:"+collectionAttributes);
  ...
  private void checkForAlwaysIn(Event event, boolean first) {
    ...
    //kaikki taulukkojen nimet talteen ensimmoisell kertaa
    //sen jolkeen vain tarkistus onko se taulukko aina matkassa, jos ei niin invariantti pois
    //samoin se parametri joka pitoisi aina olla siell
    //ja sitte katotaan onko parametri siin taulukossa, jos ei niin invariantti pois
  }
